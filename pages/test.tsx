...
import data, { generateTestData } from "@/lib/data";
...
export default function dataPage() {
    ...
    return (
        <>
            <Debug data={{data: generateTestData()}} />
            <div style={{
                position: 'sticky',
                width: '100%',
                minHeight: '24px',
                ...
                <div style={{
                    ...
                    }} placeholder="Enter a query" value={query} onChange={(e) => {
                ...
                <pre dangerouslySetInnerHTML={{ __html: (() => {
                    function evaluateQuery(data: any, query: string): string {
                        try {
                            ...
                            return JSON.stringify((0, eval)(/*js*/`
                                (() => {
                ...
                })() }} style={{ padding: '0px 8px', border: 'none', maxHeight: '96px', overflowX: 'hidden' }} />
            </div>
        </>
    )
}