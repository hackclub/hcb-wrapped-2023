...
import Slides from "../utils/slidesHelper";
import React from "react";
export default function BankWrapped({ data }) {
        ...
        React.createElement("div", Object.assign({}, $({
            ...
            React.createElement("div", { className: "main" },
                React.createElement("div", { className: "content" },
                    React.createElement(Slides, { data: data }))),
            React.createElement("div", { className: "footer" },
                React.createElement("div", { className: "inner-footer" },
                    React.createElement("p", null,
                        "Bank Wrapped 2023",
                        React.createElement("span", { style: { whiteSpace: "pre" } }, " | "),
                        React.createElement("a", { href: "https://hackclub.com/hcb", target: "_blank" }, "Hack Club HCB"),
                        React.createElement("span", { style: { whiteSpace: "pre" } }, " | "),
                        React.createElement("a", { href: "https://github.com/hackclub/hcb-wrapped-2023", target: "_blank" }, "Source Code"))))),
        React.createElement("div", { className: "bg-wrapper" },
...
`;
//# sourceMappingURL=BankWrapped.js.map