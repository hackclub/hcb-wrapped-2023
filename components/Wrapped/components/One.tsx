...
export default function OnePager({ data }: { data: WrappedData }) {
        ...
        >
          ...
          >
            <h1 {...$.title({ fontSize: "2.2em" })}>
              ...
              {Math.abs(data.individual.totalMoneySpent / 100)} this year on
              HCB.
            </h1>
          </div>
          <div
...
body {
  background: url("https://cloud-ppjsbwxdm-hack-club-bot.vercel.app/0secretfreeze.svg"), var(--primary);
