...
const additionalData: {
  ...
  "PAYPAL": {
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/PayPal_Logo_Icon_2014.svg/1664px-PayPal_Logo_Icon_2014.svg.png",
    color: $.blue
  },
  "AMAZON": {
  ...
  "STICKER MULE": {
    image: "https://cdn.icon-icons.com/icons2/2699/PNG/512/stickermule_logo_icon_169715.png",
    color: $.red
  },
  "KIT LENDER": {
    image: "https://cloud-4jlvg7r0t-hack-club-bot.vercel.app/0screenshot_2023-12-15_at_12.40.20___am.png",
    color: $.green
  },
  "PREMIER COACH COMPANY INC": {
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Bus-logo.svg/2048px-Bus-logo.svg.png",
    color: $.muted
  }
}
...
export default function HCBTopMerchants({ data }: SlideProps) {
  let categories = Object.entries(data.hcb.spendingByCategory).sort((a,b) => b[1]-a[1]).filter(x => x[0] != "WIRES_MONEY_ORDERS").map(category => prettifyCategory(category[0])).slice(0, 5)
  return (
    <>
      <div
        style={{
      ...
      <div {...$({animate$fadeIn: {
        ...
        <p {...$.lead({ color: "white", marginTop: $.s1 })}>
          HCB cards were used at {Object.keys(data.hcb.spendingByMerchant).length.toLocaleString()} different merchants over the past year.
        </p></div>
        <div
          {...$({
            display: "grid",
        ...
        >
          Most money was spent at {categories[0]}, {categories[1]}, {categories[2]}, {categories[3]}, and {categories[4]}.
        </div>
        <Background />
      </div>
    </>
